...
export default {
  ...
  activate(state) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {'subnetreplacer:tomask': () => this.tomask()}));
    this.subscriptions.add(atom.commands.add('atom-workspace', {'subnetreplacer:toinversemask': () => this.toinversemask()}));
    this.subscriptions.add(atom.commands.add('atom-workspace', {'subnetreplacer:toprefix': () => this.toprefix()}));
  },
